...
<div class="relative">
    <input
        ...
        class="block {{$withd}} p-1 text-gray-900 border-1 border-gray-300 rounded-lg bg-gray-50 text-sm leading-none focus:border-blue-600 focus:outline-none focus:ring-0
